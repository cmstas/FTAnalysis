...
void babyMaker::MakeBabyNtuple(const char* output_name, int isFastsim){
  ...
  if (applyBtagSFs) {
    ...
    // calib = new BTagCalibration("deepcsv", "CORE/Tools/btagsf/data/run2_25ns/DeepCSV_Moriond17_B_H.csv"); // https://twiki.cern.ch/twiki/bin/view/CMS/BtagRecommendation80X
