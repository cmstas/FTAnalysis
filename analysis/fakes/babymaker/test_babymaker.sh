...
run   mc_2016_94x     "/DYJetsToLL"                       ${outputdir}/test_2016_94x_dy.root              ${outputdir}/log_2016_94x_dy.txt              &
...
run   data_2016_94x   "/DoubleMuon/Run2016C"              ${outputdir}/test_2016_94x_datamuc.root         ${outputdir}/log_2016_94x_datamuc.txt         &
run   data_2016_94x   "/DoubleEG/Run2016C"                ${outputdir}/test_2016_94x_dataelc.root         ${outputdir}/log_2016_94x_dataelc.txt         &
