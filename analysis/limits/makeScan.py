...
def make_scan(thedir, noredocard=False, do_blind=True):
    ...
    cmd = "combine  -M MultiDimFit --algo grid --setPhysicsModelParameterRanges r=0,6.5 --saveFitResult --redefineSignalPOI r {0} ; python ../limits/plot1DScan.py  higgsCombineTest.MultiDimFit.mH120.root --main-label Observed ".format(fullcard)
