...
for year in [2016, 2017, 2018]:
    ...
    print r.fakeRate(year, id1, pt1, eta1, ht) 
    print r.fakeRateError(year, id1, pt1, eta1, ht) 
    print r.alternativeFakeRate(year, id1, pt1, eta1, ht) 
    print r.getTruePUw(year, nvtx)
    print r.getTruePUw(year, nvtx, 1)
    print r.getTruePUw(year, nvtx, -1)
    print r.triggerScaleFactor(year, id1, id2, pt1, pt2, eta1, eta2, ht)
