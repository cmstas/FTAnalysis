...
protected: 
	...
	vector<float> *jets_disc_ivf_;
	TBranch *jets_disc_ivf_branch;
	bool     jets_disc_ivf_isLoaded;
...
void LoadAllBranches(); 
	...
	const vector<float> &jets_disc_ivf();
