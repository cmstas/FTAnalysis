...
# # bst = pickle.load(open("bst_run2_ssos_v2.pkl","rb"))
# # y_pred = bst.predict(xgb.DMatrix(x_data))
# # y_pred.dump("ypred_run2_ssos_v2.npy")
# y_pred = np.load("ypred_run2_ssos_v2.npy")

# # bst = pickle.load(open("bst_run2_v2.pkl","rb"))
# # y_pred = bst.predict(xgb.DMatrix(x_data))
